    ...
    Scaffold(bottomBar = { BottomBar(navController) },
        ...
        Column(
            ...
            Column(modifier = Modifier.padding(vertical = 16.dp)) {
                ProfileCard(color = black, icon = R.drawable.profile_icon_primary, title = "Atur Profile", onClick = {})
                ProfileCard(color = black, icon = R.drawable.profile_riwayat_icon, title = "Riwayat Transaksi", onClick = {})
                ProfileCard(color = black, icon = R.drawable.profile_privasi_icon, title = "Kebijakan Privasi", onClick = {})
                ProfileCard(color = black, icon = R.drawable.profile_help_icon, title = "Pusat Bantuan", onClick = {})
                ProfileCard(color = black, icon = R.drawable.profile_setting_icon, title = "Pengaturan Akun", onClick = {})
                ProfileCard(color = danger_bold, icon = R.drawable.profile_logout_icon, title = "Keluar", onClick = {navController.navigate(
                    loginScreen)})
            }
